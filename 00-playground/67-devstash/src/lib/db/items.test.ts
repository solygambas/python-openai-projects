...
const { findFirstMock, updateMock, deleteMock, transactionMock, createMock, findUniqueMock } = vi.hoisted(() => ({
 findFirstMock: vi.fn(),
 updateMock: vi.fn(),
 deleteMock: vi.fn(),
...
import { getItemDetailById, updateItem, deleteItem, createItem } from "@/lib/db/items";
