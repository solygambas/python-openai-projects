...
export function ProfileStats({ itemTypeCounts, collectionStats }: ProfileStatsProps) {
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="p-4 bg-muted/50 rounded-lg">
              ...
              <p className="text-2xl font-bold">{collectionStats.collectionCount}</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <p className="text-sm text-muted-foreground">Favorite Items</p>
              <p className="text-2xl font-bold">{collectionStats.favoriteItemCount}</p>
            </div>
            <div className="p-4 bg-muted/50 rounded-lg">
              <p className="text-sm text-muted-foreground">Favorite Collections</p>
              <p className="text-2xl font-bold">{collectionStats.favoriteCollectionCount}</p>
            </div>
          </div>
        </CardContent>
      </Card>
